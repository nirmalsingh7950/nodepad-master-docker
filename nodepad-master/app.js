...
//  app.set('db-uri', 'mongodb://172.18.0.2:27017/nodepad-development');
...
//  app.set('db-uri', 'mongodb://172.18.0.2:27017/nodepad-test');
  app.set('view options', {
    pretty: true
  });  
});
...
//  app.set('db-uri', 'mongodb://172.18.0.2:27017/nodepad-production');
});
